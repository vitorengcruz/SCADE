...
static SimEnumValUtils SSM_ST_SM1_values[] = {
    ...
    { "DOWN", SSM_st_DOWN_SM1},
    { "TRANSITION", SSM_st_TRANSITION_SM1},
    { "TRANSITION", SSM_st_TRANSITION_SM1},
    { "UP", SSM_st_UP_SM1},
    { "UP", SSM_st_UP_SM1},
};
...
{
    *(SSM_ST_SM1*)pValue = SSM_st_DOWN_SM1;
    return 1;
}
...
static SimEnumValUtils SSM_TR_SM1_values[] = {
    ...
    { "SSM_TR_no_trans_SM1", SSM_TR_no_trans_SM1},
    { "SSM_TR_DOWN_TRANSITION_1_DOWN_SM1", SSM_TR_DOWN_TRANSITION_1_DOWN_SM1},
    { "SSM_TR_DOWN_TRANSITION_1_DOWN_SM1", SSM_TR_DOWN_TRANSITION_1_DOWN_SM1},
    { "SSM_TR_TRANSITION_UP_1_TRANSITION_SM1", SSM_TR_TRANSITION_UP_1_TRANSITION_SM1},
    { "SSM_TR_TRANSITION_UP_1_TRANSITION_SM1", SSM_TR_TRANSITION_UP_1_TRANSITION_SM1},
    { "SSM_TR_TRANSITION_DOWN_2_TRANSITION_SM1", SSM_TR_TRANSITION_DOWN_2_TRANSITION_SM1},
    { "SSM_TR_TRANSITION_DOWN_2_TRANSITION_SM1", SSM_TR_TRANSITION_DOWN_2_TRANSITION_SM1},
    { "SSM_TR_UP_TRANSITION_1_UP_SM1", SSM_TR_UP_TRANSITION_1_UP_SM1},
    { "SSM_TR_UP_TRANSITION_1_UP_SM1", SSM_TR_UP_TRANSITION_1_UP_SM1},
};
...
int release_T_String(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_T_String(void *pToValue, const void *pFromValue)
{
    kcg_copy_T_String((T_String*)pToValue, (T_String*)pFromValue);
    return 1;
}
