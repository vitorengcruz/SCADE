...
#   define INITC_project2(context) project2_init(&context.outputs_ctx);
#else
#   ifndef KCG_NO_EXTERN_CALL_TO_RESET
#       define INITC_project2(context) project2_reset(&context.outputs_ctx);
#   else
#       define INITC_project2(context) 
#   endif
#endif
