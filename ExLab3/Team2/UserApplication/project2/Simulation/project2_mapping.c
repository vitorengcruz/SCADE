...
const MappingEntry scope_1_entries[17] = {
    ...
    /* 2 */ { MAP_OUTPUT, "SignalToTeam1", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx.SignalToTeam1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 2 },
    ...
    /* 6 */ { MAP_INPUT, "SignalFromTeam1", NULL, sizeof(kcg_bool), (size_t)&inputs_ctx.SignalFromTeam1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L2, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 7 },
    ...
    /* 10 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L5, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_uint8), (size_t)&outputs_ctx._L6, &_Type_kcg_uint8_Utils, NULL, NULL, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_uint8), (size_t)&outputs_ctx._L7, &_Type_kcg_uint8_Utils, NULL, NULL, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_uint8), (size_t)&outputs_ctx._L8, &_Type_kcg_uint8_Utils, NULL, NULL, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L9, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L10, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 15 },
