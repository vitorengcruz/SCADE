...
#ifndef project2_UA_1_DEFAULT_CONTEXT_NUMBER
#define project2_UA_1_DEFAULT_CONTEXT_NUMBER 0xDEFA
#endif

/* Input Buffer size (bytes) for data from the server */
#ifndef project2_UA_1_MAX_SIZE_INPUT_BUFFER
#define project2_UA_1_MAX_SIZE_INPUT_BUFFER 1000000UL
#endif

/* Output Buffer size (bytes) for data to send to the server */
#ifndef project2_UA_1_MAX_SIZE_OUTPUT_BUFFER
#define project2_UA_1_MAX_SIZE_OUTPUT_BUFFER 1000000UL
#endif
...
extern uaa_size project2_UA_1_send(buffer_el msg[], outC_project2* scade_ctx,
  extern_out_ctx_t* extern_out_ctx);

/* Receive notifications from the A661 server */
extern uaa_size project2_UA_1_receive(buffer_el buffer[], uaa_size buffer_size,
