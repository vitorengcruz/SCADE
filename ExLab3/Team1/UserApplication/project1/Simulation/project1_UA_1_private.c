...
/* Widget GpArcEllipse for parameter A661_FILL_INDEX */
...
/* Pack messages for widget GpArcEllipse: A661_FILL_INDEX */
 uaa_size a661_com_csp_widget_GpArcEllipse(buffer_el msg[], 
