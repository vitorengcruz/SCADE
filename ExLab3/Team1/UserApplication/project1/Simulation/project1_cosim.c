...
void AfterSimInit(void){
	...
	#endif
	pszBinListFiles[0] = "C:/Repositorio_ITA/SCADE/ExLab3/Team1/UserApplication/project1/Simulation/project1_UA_1_binaries.txt";
	pszBinListFiles[1] = 0;
	if (0/*OK*/ != A661ConnectServer("127.0.0.1", 1231, pszBinListFiles, "C:/Repositorio_ITA/SCADE/ExLab3/Team1/UserApplication/project1/Simulation/project1_UA_1_conf.xml" )) {
		const char *pszError;
...
void BeforeSimStep(void){
	static buffer_el msg[project1_UA_1_MAX_SIZE_INPUT_BUFFER];
	/* reveive from server */
