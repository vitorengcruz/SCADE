...
{
  uaa_size delta = (uaa_size)(((unsigned)msg) % 4);
  uaa_size n = 4 - delta;
  switch(delta)
    {
    case 1: msg[0] = 0;
...
{
  uaa_size delta = (uaa_size)(((unsigned)msg) % 2);
  uaa_size n = 2 - delta;
  switch(delta)
    {
...
{
  msg[0] = (buffer_el)real_to_fr( val, 8, max);
  return 1;
}
#endif /* kcg_real */
...
{
  msg[0] = (buffer_el)float32_to_fr( val, 8, max);
  return 1;
}
#endif /* kcg_float32 */
...
{
  msg[0] = (buffer_el)float64_to_fr( val, 8, max);
  return 1;
}
#endif /* kcg_float64 */
...
/* Widget GpArcCircle for parameter A661_FILL_INDEX */
 uaa_size a661_com_msg_char(buffer_el msg[], 
  uaa_uint16 pid,  kcg_int A661_FILL_INDEX_FillIndex_){
...
/* Pack messages for widget GpArcCircle: A661_FILL_INDEX */
 uaa_size a661_com_csp_widget_GpArcCircle(buffer_el msg[], 
  uaa_uint16 wid,  uaa_bool A661_FILL_INDEX__emit__, 
  kcg_int A661_FILL_INDEX_FillIndex_){
  uaa_size offset = 0;
