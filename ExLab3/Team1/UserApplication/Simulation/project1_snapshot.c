...
const char* szKcgTraceCheckSum = "f8f02b706168f58164da0e6c64466f59";
...
int save_inC_project1(const char *cpath, const inC_project1 *pValue, const void *pBaseAddr, FILE *snsFile) {
    int bOK = 1;
    bOK &= save_field(cpath, ".SignalFromButton", (const void *)(&pValue->SignalFromButton), pBaseAddr, kcg_bool_to_string, snsFile); 
    bOK &= save_field(cpath, ".SignalFromTeam2", (const void *)(&pValue->SignalFromTeam2), pBaseAddr, kcg_bool_to_string, snsFile); 
    return bOK;
}

int save_outC_project1(const char *cpath, const outC_project1 *pValue, const void *pBaseAddr, FILE *snsFile) {
    int bOK = 1;
    ...
    bOK &= save_field(cpath, ".SignalToTeam2", (const void *)(&pValue->SignalToTeam2), pBaseAddr, kcg_bool_to_string, snsFile); 
    ...
    bOK &= save_field(cpath, "._L5", (const void *)(&pValue->_L5), pBaseAddr, kcg_bool_to_string, snsFile); 
    bOK &= save_field(cpath, "._L3", (const void *)(&pValue->_L3), pBaseAddr, kcg_bool_to_string, snsFile); 
    bOK &= save_field(cpath, "._L5_1", (const void *)(&pValue->_L5_1), pBaseAddr, kcg_bool_to_string, snsFile); 
    return bOK;
}
...
int save_snapshot(const char *szFilePath, size_t nCycle,
    ...
    bOK &= save_inC_project1("inC", inC, (const void*)inC, snsFile);
    bOK &= save_outC_project1("outC", outC, (const void*)outC, snsFile);
...
int load_inC_project1(inC_project1 *pValue, FILE *snsFile) {
    int bOK = 1;
    bOK &= load_var((void *)(&pValue->SignalFromButton), string_to_kcg_bool, snsFile); 
    bOK &= load_var((void *)(&pValue->SignalFromTeam2), string_to_kcg_bool, snsFile); 
    return bOK;
}

int load_outC_project1(outC_project1 *pValue, FILE *snsFile) {
    int bOK = 1;
    ...
    bOK &= load_var((void *)(&pValue->SignalToTeam2), string_to_kcg_bool, snsFile); 
    ...
    bOK &= load_var((void *)(&pValue->_L5), string_to_kcg_bool, snsFile); 
    bOK &= load_var((void *)(&pValue->_L3), string_to_kcg_bool, snsFile); 
    bOK &= load_var((void *)(&pValue->_L5_1), string_to_kcg_bool, snsFile); 
    return bOK;
}
...
int load_snapshot(const char *szFilePath, size_t *nCycle,
    ...
    if (bOK) {
        bOK &= load_inC_project1(inC, snsFile);
        bOK &= load_outC_project1(outC, snsFile);
    }
